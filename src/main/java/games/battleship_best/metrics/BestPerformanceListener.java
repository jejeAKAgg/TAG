package games.battleship_best.metrics;
...
import games.battleship_best.BattleshipGameState;
...
public class BestPerformanceListener implements IGameListener {
    ...
    public boolean setOutputDirectory(String... folders) {
        try {
            ...
            System.out.println(">>> BestPerformanceListener → " + path);
            return true;
        } catch (Exception e) {
            System.err.println("BestPerformanceListener — error setOutputDirectory : " + e.getMessage());
            return false;
        }
    }
