...
public enum GameType {
    ...
    BASICBattleship(2, 2,
            ...
            games.battleship_basic.BattleshipGameState.class, games.battleship_basic.BattleshipForwardModel.class, games.battleship_basic.BattleshipParameters.class, games.battleship_basic.gui.BattleshipGUIManager.class),
    BESTOLDBattleship(2, 2,
            Arrays.asList(Abstract, Deduction, Wargame),
            Collections.singletonList(Memory),
            games.battleship_best_old.BattleshipGameState.class, games.battleship_best_old.BattleshipForwardModel.class, games.battleship_best_old.BattleshipParameters.class, games.battleship_best_old.gui.BattleshipGUIManager.class),
    BESTBattleship(2, 2,
            Arrays.asList(Abstract, Deduction, Wargame),
            Collections.singletonList(Memory),
            games.battleship_best.BattleshipGameState.class, games.battleship_best.BattleshipForwardModel.class, games.battleship_best.BattleshipParameters.class, games.battleship_best.gui.BattleshipGUIManager.class),
    SMARTBattleship(2, 2,
            Arrays.asList(Abstract, Deduction, Wargame),
            Collections.singletonList(Memory),
            games.battleship_smart.BattleshipGameState.class, games.battleship_smart.BattleshipForwardModel.class, games.battleship_smart.BattleshipParameters.class, games.battleship_smart.gui.BattleshipGUIManager.class),
    Connect4(2, 2,
            Arrays.asList(Simple, Abstract),
            Collections.singletonList(PatternBuilding),
