...
public enum GameType {
    ...
    BASICBattleship(2, 2,
            ...
            games.BASICbattleship.BattleshipGameState.class, games.BASICbattleship.BattleshipForwardModel.class, games.BASICbattleship.BattleshipParameters.class, games.BASICbattleship.gui.BattleshipGUIManager.class),
    SMARTBattleship(2, 2,
            Arrays.asList(Abstract, Deduction, Wargame),
            Collections.singletonList(Memory),
