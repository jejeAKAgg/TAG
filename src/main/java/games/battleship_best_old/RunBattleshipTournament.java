...
public class RunBattleshipTournament {
    public static void main(String[] args) {
        ...
        config.put("game", "BESTOLDBattleship");
        config.put("nPlayers", "2");
        config.put("matchups", "2500");
        config.put("mode", "exhaustive");
        config.put("seed", "42");
        config.put("listener", "games.battleship_best_old.metrics.BestOldPerformanceListener");
        config.put("playerDirectory", "src/main/java/games/battleship_best_old/agents");
